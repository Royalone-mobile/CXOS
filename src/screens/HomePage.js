...
const HomePage = () => (
    <main>
        <div className="jumbotron jumbotron-fluid text-dark bg-light animated fadeIn">
            ...
            <p className="lead text-center" style={{fontSize:'12px'}}>What will actually display on this page hasn&apos;t been finalized yet, though there is some historical basis for it mapping to the &nbsp;
